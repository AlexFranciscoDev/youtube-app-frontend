...
import { faUser, faEnvelope, faCalendar, faVideo } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className="profile-layout">
                ...
                <aside className="profile-sidebar">
                    ...
                    <div className="profile-hero">
                        <div className="profile-avatar-wrap">
                            {user.image ? (
                                <img src={GlobalUploads.url + "others/" + user.image} alt="profile_picture" />
                            ) : (
                    ...
                    <div className="profile-info">
                        ...
                        <div className="profile-info-row">
                            ...
                            <span className="profile-info-row__value">@{user.username ?? '—'}</span>
                        </div>
                ...
                <main className="profile-main">
                    <div className="profile-main__header">
                        ...
                        <span className="profile-main__count">{videos.length} videos found</span>
                    </div>

                    <div className="profile__grid">
                        {videos.length === 0 ? (
                            <div className="profile__empty">
                                <FontAwesomeIcon icon={faVideo} className="profile__empty-icon" />
