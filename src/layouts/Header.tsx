...
export const Header = () => {
    ...
    const avatarSrc = user?.image ? resolveUploadUrl(user.image, "others") : undefined;
                    ...
                    {!isLoggedIn ? (
                        ...
                        <>
                            <div className="header-mobile-user">
                                ...
                                <img src={avatarSrc} alt="profile_picture" className="w-12 h-12 object-cover rounded-full"/>
